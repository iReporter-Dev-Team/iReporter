...
const AboutUs = () => {
  ...
  return (
    <div >
      ...
      <h1><span style={{ fontweight: "bold", color: "#C60021" }}>
          Welcome To &nbsp;
        </span>
        <span>iReporter</span></h1> 
      <p>
         A Platform where you can report any form of corruption or Intervention incidences.
      </p>
      </section >
      ...
      <section>
      <p className="left-half">Client's Stories</p>
